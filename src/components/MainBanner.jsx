...
function MainBanner() {
  ...
  const getDarkColor = (color) => {
    switch (color) {
      case "green":
        return "#004d00"; // Color verde oscuro
      case "orange":
        return "#cc6600"; // Color naranja oscuro
      case "red":
        return "#660000"; // Color rojo oscuro
      default:
        return "gray";
    }
  };
                  ...
                  <div className="flex items-center justify-center mb-8">
                    ...
                    >
                      ...
                      <circle
                        ...
                        cy="60"
                        r={radius}
                        stroke={darkColor} // Color oscuro para el fondo
                        strokeWidth="5"
                        fill="none"
                      />
                      {/* Progreso */}
                      <circle
                        ...
                        cy="60"
                        r={radius}
                        stroke={color} // Color basado en el porcentaje
                        strokeWidth="5"
                        fill="none"
                        strokeDasharray={circumference}
                        strokeDashoffset={getStrokeDashoffset(percentage)} // Offset para el porcentaje actual
                        strokeLinecap="round"
                      ...
                      <text
                        ...
                        fill="white" // Color del texto basado en el porcentaje
                      >
                        {percentage}%
                      </text>
                    </svg>
          ...
          <section className="overflow-hidden h-96 bg-[url(https://images.unsplash.com/photo-1489987707025-afc232f7ea0f?q=80&w=2670&auto=format&fit=crop)] bg-cover bg-top bg-no-repeat">
            <div className="bg-black/30 h-full">
              <div className="absolute bottom-0 left-0 w-full pt-4 flex justify-around items-end bg-gradient-to-b from-transparent to-black">
                ...
                <div className="mx-5 text-center">
                  <div className="text-white">97%</div>
                  <div className="flex space-x-16">
                    <svg
                      className="cursor-pointer"
                      width="24"
